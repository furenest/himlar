...
mod 'neutron', :ref => '17.7.0',                    :git => github + 'openstack/puppet-neutron'
...
mod 'keystone', :ref => '17.5.0',                   :git => github + 'openstack/puppet-keystone'
...
mod 'oslo', :ref => '17.5.0',                       :git => github + 'openstack/puppet-oslo'
mod 'openstacklib', :ref => '17.4.0',               :git => github + 'openstack/puppet-openstacklib'
mod 'openstack_extras', :ref => '17.5.0',           :git => github + 'openstack/puppet-openstack_extras'
